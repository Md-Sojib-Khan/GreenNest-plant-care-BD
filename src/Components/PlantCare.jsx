...
const PlantCare = () => {
    return (
        <div className='my-10 w-11/12 mx-auto overflow-x-hidden'>
            ...
            <div className='flex flex-col md:flex-row items-center gap-5'>
                <div data-aos="fade-right" className='flex flex-col items-center md:flex-row gap-5'>
            ...
            <div className='flex flex-col-reverse md:flex-row items-center gap-5 mt-5'>
                ...
                <div data-aos="fade-left" className='flex flex-col items-center md:flex-row gap-5'>
