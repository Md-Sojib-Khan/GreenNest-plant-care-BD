        ...
        <div className='my-10 w-11/12 mx-auto'>
            ...
            <div className='grid md:grid-cols-2 gap-5 items-center'>
                <div className='flex gap-5'>
                    <img className='rounded-2xl h-[250px] w-[300px] object-cover' src={plantCare1} alt="" />
                    <img className='rounded-2xl h-[250px] w-[300px] object-cover' src={plantCare2} alt="" />
                </div>
            ...
            <div className='grid md:grid-cols-2 gap-5 items-center mt-5'>
                <div className='md:ml-5'>
                ...
                <div className='flex gap-5'>
                    <img className='rounded-2xl h-[250px] w-[300px] object-cover' src={plantCare3} alt="" />
                    <img className='rounded-2xl h-[250px] w-[300px] object-cover' src={plantCare4} alt="" />
                </div>
            </div>
        </div>
    );
